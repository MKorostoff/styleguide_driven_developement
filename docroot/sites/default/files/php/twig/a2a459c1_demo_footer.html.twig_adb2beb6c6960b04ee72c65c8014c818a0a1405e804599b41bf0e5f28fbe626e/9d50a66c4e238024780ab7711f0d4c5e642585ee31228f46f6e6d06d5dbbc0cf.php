...
class __TwigTemplate_fa5f8d5549eef608f66a91e2ef294eebc460744a91b8a8453180339ae24b4dc3 extends Twig_Template
{
    ...
    <div class=\"footer-left\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["link"]) {
            ...
            // line 12
            echo "            <a href=\"#\">";
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->renderVar(twig_var_dump($this->env, $context, $this->getAttribute($context["link"], "title", array()))));
            echo " f</a>
        ";
        }
